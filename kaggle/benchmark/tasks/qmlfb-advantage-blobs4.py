...
@kbench.task(name="qmlfb-advantage-blobs4", description='Run the geometric-difference screen and make the conservative deployment call.')
def qmlfb_advantage_blobs4(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_advantage_blobs4.run(kbench.llm)
