...
@kbench.task(name="qmlfb-advantage-circles2", description='Run the geometric-difference screen and make the conservative deployment call.')
def qmlfb_advantage_circles2(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_advantage_circles2.run(kbench.llm)
