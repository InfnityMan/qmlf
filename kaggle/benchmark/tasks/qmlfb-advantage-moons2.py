...
@kbench.task(name="qmlfb-advantage-moons2", description='Run the geometric-difference screen and make the conservative deployment call.')
def qmlfb_advantage_moons2(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_advantage_moons2.run(kbench.llm)
