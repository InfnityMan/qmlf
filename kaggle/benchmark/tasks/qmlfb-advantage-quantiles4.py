...
@kbench.task(name="qmlfb-advantage-quantiles4", description='Run the geometric-difference screen and make the conservative deployment call.')
def qmlfb_advantage_quantiles4(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_advantage_quantiles4.run(kbench.llm)
