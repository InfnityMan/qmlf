...
Screen verdict on this data: inconclusive (g = 391.09).
"""
...
# %%
REF = {'g': 391.091322853755, 'category': 'inconclusive', 'keep': True}
PARAMS = {'kind': 'circles', 'n_features': 2}
...
@kbench.task(name="qmlfb-advantage-screen-circles-2q", description='Run the geometric-difference screen and make the conservative deployment call.')
def qmlfb_advantage_screen_circles_2q(llm) -> float:
    _ensure_qmlf()
    data = make_dataset("circles", n_samples=80, n_features=2, seed=61, class_sep=2.5)
...
# %%
qmlfb_advantage_screen_circles_2q.run(kbench.llm)
