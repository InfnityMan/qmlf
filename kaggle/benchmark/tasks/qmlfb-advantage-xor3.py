...
@kbench.task(name="qmlfb-advantage-xor3", description='Run the geometric-difference screen and make the conservative deployment call.')
def qmlfb_advantage_xor3(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_advantage_xor3.run(kbench.llm)
