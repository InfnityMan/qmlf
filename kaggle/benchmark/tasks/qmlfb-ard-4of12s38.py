...
@kbench.task(name="qmlfb-ard-4of12s38", description='Discover hidden noise features and suppress them with a per-feature quantum-kernel bandwidth.')
def qmlfb_ard_4of12s38(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_ard_4of12s38.run(kbench.llm)
