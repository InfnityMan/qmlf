...
Principle cv -> 0.1 on this training set.
"""
...
# %%
REF = {'expected': 0.1, 'keep': True}
PARAMS = {'principle': 'cv', 'kind': 'moons', 'n_features': 4}
...
@kbench.task(name="qmlfb-bandwidth-cv-moons-4q", description='Select the fidelity-kernel bandwidth by the requested principle and report exactly what it yields.')
def qmlfb_bandwidth_cv_moons_4q(llm) -> float:
    _ensure_qmlf()
...
# %%
qmlfb_bandwidth_cv_moons_4q.run(kbench.llm)
