...
PARAMS = {'principle': 'cv', 'kind': 'shift', 'n_features': 5}
...
@kbench.task(name="qmlfb-bandwidth-cv-shift-5q", description='Select the fidelity-kernel bandwidth by the requested principle and report exactly what it yields.')
def qmlfb_bandwidth_cv_shift_5q(llm) -> float:
    _ensure_qmlf()
...
# %%
qmlfb_bandwidth_cv_shift_5q.run(kbench.llm)
