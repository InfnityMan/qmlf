...
Principle median -> 0.221605 on this training set.
"""
...
# %%
REF = {'expected': 0.22160544176938782, 'keep': True}
PARAMS = {'principle': 'median', 'kind': 'blobs', 'n_features': 6}
...
@kbench.task(name="qmlfb-bandwidth-median-blobs-6q", description='Select the fidelity-kernel bandwidth by the requested principle and report exactly what it yields.')
def qmlfb_bandwidth_median_blobs_6q(llm) -> float:
    _ensure_qmlf()
...
# %%
qmlfb_bandwidth_median_blobs_6q.run(kbench.llm)
