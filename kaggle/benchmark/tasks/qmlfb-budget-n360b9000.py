...
@kbench.task(name="qmlfb-budget-n360b9000", description='Stay inside a hardware circuit budget with Nystrom landmarks while keeping accuracy.')
def qmlfb_budget_n360b9000(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_budget_n360b9000.run(kbench.llm)
