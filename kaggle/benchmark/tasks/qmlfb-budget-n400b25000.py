...
@kbench.task(name="qmlfb-budget-n400b25000", description='Stay inside a hardware circuit budget with Nystrom landmarks while keeping accuracy.')
def qmlfb_budget_n400b25000(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_budget_n400b25000.run(kbench.llm)
