...
@kbench.task(name="qmlfb-bwselect-cv-blobs6", description='Select the fidelity-kernel bandwidth by the requested principle and report exactly what it yields.')
def qmlfb_bwselect_cv_blobs6(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_bwselect_cv_blobs6.run(kbench.llm)
