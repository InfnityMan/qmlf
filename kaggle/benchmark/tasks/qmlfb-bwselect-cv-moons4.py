...
@kbench.task(name="qmlfb-bwselect-cv-moons4", description='Select the fidelity-kernel bandwidth by the requested principle and report exactly what it yields.')
def qmlfb_bwselect_cv_moons4(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_bwselect_cv_moons4.run(kbench.llm)
