...
@kbench.task(name="qmlfb-bwselect-median-shift5", description='Select the fidelity-kernel bandwidth by the requested principle and report exactly what it yields.')
def qmlfb_bwselect_median_shift5(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_bwselect_median_shift5.run(kbench.llm)
