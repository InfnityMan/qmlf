...
@kbench.task(name="qmlfb-chem-s10n3", description="Produce qmlf's charge-aware Coulomb descriptor and model Hamiltonian for a geometry.")
def qmlfb_chem_s10n3(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_chem_s10n3.run(kbench.llm)
