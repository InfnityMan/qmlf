...
@kbench.task(name="qmlfb-chem-s11n5", description="Produce qmlf's charge-aware Coulomb descriptor and model Hamiltonian for a geometry.")
def qmlfb_chem_s11n5(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_chem_s11n5.run(kbench.llm)
