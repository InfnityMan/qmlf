...
Standard classical models: 0.87-1.00; auto quantum: 0.97.
"""
...
# %%
REF = {'c_min': 0.8666666666666667, 'c_max': 1.0, 'q_auto': 0.9666666666666667, 'c_bar': 0.79, 'q_bar': 0.89, 'keep': True}
...
@kbench.task(name="qmlfb-classical-baseline-blobs-6q", description='Build a competent classical baseline AND a tuned quantum model; report calibrated estimates and a consistent verdict.')
def qmlfb_classical_baseline_blobs_6q(llm) -> float:
    _ensure_qmlf()
    data = make_dataset("blobs", n_samples=120, n_features=6, seed=13, class_sep=1.0)
...
# %%
qmlfb_classical_baseline_blobs_6q.run(kbench.llm)
