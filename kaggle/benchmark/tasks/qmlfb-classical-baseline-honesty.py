...
Standard classical models score 0.77-0.87 on this data; the auto-tuned
quantum classifier scores 0.800. The model must build
...
# %%
qmlf_classical_baseline_honesty.run(kbench.llm)
