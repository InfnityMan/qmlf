...
@kbench.task(name="qmlfb-conc-blobs10", description='Configure a quantum kernel classifier that escapes concentration on this dataset.')
def qmlfb_conc_blobs10(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_conc_blobs10.run(kbench.llm)
