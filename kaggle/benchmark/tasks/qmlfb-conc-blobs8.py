...
@kbench.task(name="qmlfb-conc-blobs8", description='Configure a quantum kernel classifier that escapes concentration on this dataset.')
def qmlfb_conc_blobs8(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_conc_blobs8.run(kbench.llm)
