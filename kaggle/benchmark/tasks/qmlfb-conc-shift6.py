...
@kbench.task(name="qmlfb-conc-shift6", description='Configure a quantum kernel classifier that escapes concentration on this dataset.')
def qmlfb_conc_shift6(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_conc_shift6.run(kbench.llm)
