...
@kbench.task(name="qmlfb-debug-set1", description='Find and fix the planted bugs in a quantum kernel + mitigation pipeline.')
def qmlfb_debug_set1(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_debug_set1.run(kbench.llm)
