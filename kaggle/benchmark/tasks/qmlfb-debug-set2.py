...
@kbench.task(name="qmlfb-debug-set2", description='Find and fix the planted bugs in a quantum kernel + mitigation pipeline.')
def qmlfb_debug_set2(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_debug_set2.run(kbench.llm)
