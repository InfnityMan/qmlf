...
@kbench.task(name="qmlfb-debug-set3", description='Find and fix the planted bugs in a quantum kernel + mitigation pipeline.')
def qmlfb_debug_set3(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_debug_set3.run(kbench.llm)
