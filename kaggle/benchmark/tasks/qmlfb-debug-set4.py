...
@kbench.task(name="qmlfb-debug-set4", description='Find and fix the planted bugs in a quantum kernel + mitigation pipeline.')
def qmlfb_debug_set4(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_debug_set4.run(kbench.llm)
