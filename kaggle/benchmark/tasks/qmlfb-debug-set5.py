...
@kbench.task(name="qmlfb-debug-set5", description='Find and fix the planted bugs in a quantum kernel + mitigation pipeline.')
def qmlfb_debug_set5(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_debug_set5.run(kbench.llm)
