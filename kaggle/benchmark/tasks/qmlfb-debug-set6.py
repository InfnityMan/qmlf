...
@kbench.task(name="qmlfb-debug-set6", description='Find and fix the planted bugs in a quantum kernel + mitigation pipeline.')
def qmlfb_debug_set6(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_debug_set6.run(kbench.llm)
