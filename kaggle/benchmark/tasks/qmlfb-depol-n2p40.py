...
@kbench.task(name="qmlfb-depol-n2p40", description='Recover the ideal distribution from a known global depolarizing channel.')
def qmlfb_depol_n2p40(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_depol_n2p40.run(kbench.llm)
