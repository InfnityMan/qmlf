...
@kbench.task(name="qmlfb-depol-n4p10", description='Recover the ideal distribution from a known global depolarizing channel.')
def qmlfb_depol_n4p10(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_depol_n4p10.run(kbench.llm)
