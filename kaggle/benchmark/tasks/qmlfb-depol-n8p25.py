...
@kbench.task(name="qmlfb-depol-n8p25", description='Recover the ideal distribution from a known global depolarizing channel.')
def qmlfb_depol_n8p25(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_depol_n8p25.run(kbench.llm)
