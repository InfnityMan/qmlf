...
@kbench.task(name="qmlfb-determinism-qiga", description='Make a stochastic qmlf component bit-reproducible using its determinism knob.')
def qmlfb_determinism_qiga(llm) -> dict:
...
# %%
qmlfb_determinism_qiga.run(kbench.llm)
