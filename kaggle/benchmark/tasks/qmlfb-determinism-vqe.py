...
@kbench.task(name="qmlfb-determinism-vqe", description='Make a stochastic qmlf component bit-reproducible using its determinism knob.')
def qmlfb_determinism_vqe(llm) -> dict:
...
# %%
qmlfb_determinism_vqe.run(kbench.llm)
