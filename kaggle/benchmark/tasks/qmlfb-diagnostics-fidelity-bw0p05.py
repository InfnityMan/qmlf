...
fidelity kernel, bandwidth 0.05: offdiag 0.2496, KTA 0.4726, verdict healthy.
"""
...
@kbench.task(name="qmlfb-diagnostics-fidelity-bw0p05", description='Report the exact concentration/alignment diagnostics of a specified quantum kernel.')
def qmlfb_diagnostics_fidelity_bw0p05(llm) -> float:
    _ensure_qmlf()
    data = make_dataset("blobs", n_samples=60, n_features=5, seed=111)
...
# %%
qmlfb_diagnostics_fidelity_bw0p05.run(kbench.llm)
