...
@kbench.task(name="qmlfb-diagnostics-fidelitybw5", description='Report the exact concentration/alignment diagnostics of a specified quantum kernel.')
def qmlfb_diagnostics_fidelitybw5(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_diagnostics_fidelitybw5.run(kbench.llm)
