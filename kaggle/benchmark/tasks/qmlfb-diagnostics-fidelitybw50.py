...
@kbench.task(name="qmlfb-diagnostics-fidelitybw50", description='Report the exact concentration/alignment diagnostics of a specified quantum kernel.')
def qmlfb_diagnostics_fidelitybw50(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_diagnostics_fidelitybw50.run(kbench.llm)
