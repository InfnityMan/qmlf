...
projected kernel, bandwidth 0.25: offdiag 0.3669, KTA 0.0920, verdict healthy.
"""
...
@kbench.task(name="qmlfb-diagnostics-projected-bw0p25", description='Report the exact concentration/alignment diagnostics of a specified quantum kernel.')
def qmlfb_diagnostics_projected_bw0p25(llm) -> float:
    _ensure_qmlf()
    data = make_dataset("blobs", n_samples=60, n_features=5, seed=112)
...
# %%
qmlfb_diagnostics_projected_bw0p25.run(kbench.llm)
