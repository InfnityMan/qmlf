...
@kbench.task(name="qmlfb-diagnostics-projectedbw25", description='Report the exact concentration/alignment diagnostics of a specified quantum kernel.')
def qmlfb_diagnostics_projectedbw25(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_diagnostics_projectedbw25.run(kbench.llm)
