...
@kbench.task(name="qmlfb-entangle-blobs5s5", description='Reach the accuracy bar with the minimum number of entangling gates.')
def qmlfb_entangle_blobs5s5(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_entangle_blobs5s5.run(kbench.llm)
