...
@kbench.task(name="qmlfb-entangle-blobs6s43", description='Reach the accuracy bar with the minimum number of entangling gates.')
def qmlfb_entangle_blobs6s43(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_entangle_blobs6s43.run(kbench.llm)
