...
@kbench.task(name="qmlfb-entangle-shift5s42", description='Reach the accuracy bar with the minimum number of entangling gates.')
def qmlfb_entangle_shift5s42(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_entangle_shift5s42.run(kbench.llm)
