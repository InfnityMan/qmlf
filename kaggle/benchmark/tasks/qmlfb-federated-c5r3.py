...
@kbench.task(name="qmlfb-federated-c5r3", description='Produce the exact sample-weighted FedAvg update under partial client participation.')
def qmlfb_federated_c5r3(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_federated_c5r3.run(kbench.llm)
