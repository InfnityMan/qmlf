...
@kbench.task(name="qmlfb-federated-c8r5", description='Produce the exact sample-weighted FedAvg update under partial client participation.')
def qmlfb_federated_c8r5(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_federated_c8r5.run(kbench.llm)
