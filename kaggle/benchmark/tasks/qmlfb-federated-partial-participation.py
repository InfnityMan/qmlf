...
def qmlf_federated_partial_participation(llm) -> dict:
    ...
    expected = np.asarray([0.176596245023419, -0.36337481375400094, -0.46585463095418794, 1.1775568302351036, 0.07189314096362037, -0.03114176197260185])
    unweighted = np.asarray([-0.08112544725947908, -0.4825823153421398, -0.6372514808351853, 0.3748530035829194, -0.3805183265641226, 0.4966663149940643])
...
# %%
qmlf_federated_partial_participation.run(kbench.llm)
