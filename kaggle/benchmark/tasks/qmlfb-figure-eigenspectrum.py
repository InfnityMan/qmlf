...
QVizPro.plot_kernel_eigenvalues(gram, ...) written to HTML, no display.
"""
...
@kbench.task(name="qmlfb-figure-eigenspectrum", description='Produce a qmlf research figure in a headless sandbox and write it to disk.')
def qmlfb_figure_eigenspectrum(llm) -> float:
...
# %%
qmlfb_figure_eigenspectrum.run(kbench.llm)
