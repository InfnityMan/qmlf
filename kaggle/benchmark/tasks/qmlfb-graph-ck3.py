...
@kbench.task(name="qmlfb-graph-ck3", description="Build qmlf's graph-diffusion kernel with the specified backend and neighbourhood, including out-of-sample similarity.")
def qmlfb_graph_ck3(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_graph_ck3.run(kbench.llm)
