...
@kbench.task(name="qmlfb-graph-qk3", description="Build qmlf's graph-diffusion kernel with the specified backend and neighbourhood, including out-of-sample similarity.")
def qmlfb_graph_qk3(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_graph_qk3.run(kbench.llm)
