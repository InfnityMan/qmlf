...
@kbench.task(name="qmlfb-honesty-moons4", description='Build a competent classical baseline AND a tuned quantum model; report calibrated estimates and a consistent verdict.')
def qmlfb_honesty_moons4(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_honesty_moons4.run(kbench.llm)
