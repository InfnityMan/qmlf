...
PROMPT = """\
Professional QML practice demands a competent classical baseline next to every quantum model, honest estimates, and a verdict that follows from them. Dataset: 6 features, binary. `qmlf` is installed (qmlf.QuantumClassifier() auto-tunes; its CV table is in .cv_results_); sklearn is available. Write
