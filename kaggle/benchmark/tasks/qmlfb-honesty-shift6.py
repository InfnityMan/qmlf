...
@kbench.task(name="qmlfb-honesty-shift6", description='Build a competent classical baseline AND a tuned quantum model; report calibrated estimates and a consistent verdict.')
def qmlfb_honesty_shift6(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_honesty_shift6.run(kbench.llm)
