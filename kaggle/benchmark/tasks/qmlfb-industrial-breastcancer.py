...
@kbench.task(name="qmlfb-industrial-breastcancer", description='Configure a production quantum-kernel pipeline on real data: reduce, encode, tune.')
def qmlfb_industrial_breastcancer(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_industrial_breastcancer.run(kbench.llm)
