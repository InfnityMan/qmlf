...
iris: naive 0.50, auto 0.92, projected 0.89, classical RBF 0.95.
"""
...
# %%
REF = {'naive_acc': 0.5, 'auto_acc': 0.9210526315789473, 'projected_acc': 0.8947368421052632, 'classical': 0.9473684210526315, 'acc_bar': 0.86, 'keep': True}
PARAMS = {'name': 'iris', 'label': 'iris', 'n_features': 4, 'classes': '3 classes'}
...
@kbench.task(name="qmlfb-industrial-iris", description='Configure a production quantum-kernel pipeline on real data: reduce, encode, tune.')
def qmlfb_industrial_iris(llm) -> float:
    _ensure_qmlf()
    data = make_real("iris")
...
# %%
qmlfb_industrial_iris.run(kbench.llm)
