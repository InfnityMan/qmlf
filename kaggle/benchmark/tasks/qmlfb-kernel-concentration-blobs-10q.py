...
Naive (bandwidth 1.0): acc 0.46, off-diagonal 0.0010. Tuned: 0.96 / 0.37. Data: make_dataset("blobs", n_samples=110, n_features=10, seed=6)
"""
...
# %%
REF = {'naive_acc': 0.4642857142857143, 'naive_offdiag': 0.00101585541402786, 'ceiling_acc': 0.9642857142857143, 'ceiling_offdiag': 0.37246788673515024, 'offdiag_bar': 0.1, 'acc_bar': 0.88, 'keep': True}
PARAMS = {'kind': 'blobs', 'n_features': 10}
...
@kbench.task(name="qmlfb-kernel-concentration-blobs-10q", description='Configure a quantum kernel classifier that escapes concentration on this dataset.')
def qmlfb_kernel_concentration_blobs_10q(llm) -> float:
    _ensure_qmlf()
    data = make_dataset("blobs", n_samples=110, n_features=10, seed=6)
...
# %%
qmlfb_kernel_concentration_blobs_10q.run(kbench.llm)
