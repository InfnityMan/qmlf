...
Naive (bandwidth 1.0): acc 0.54, off-diagonal 0.0158. Tuned: 0.93 / 0.17. Data: make_dataset("blobs", n_samples=110, n_features=6, seed=1)
"""
...
# %%
REF = {'naive_acc': 0.5357142857142857, 'naive_offdiag': 0.01577124436694296, 'ceiling_acc': 0.9285714285714286, 'ceiling_offdiag': 0.16635737458395197, 'offdiag_bar': 0.1, 'acc_bar': 0.85, 'keep': True}
PARAMS = {'kind': 'blobs', 'n_features': 6}
...
@kbench.task(name="qmlfb-kernel-concentration-blobs-6q", description='Configure a quantum kernel classifier that escapes concentration on this dataset.')
def qmlfb_kernel_concentration_blobs_6q(llm) -> float:
    _ensure_qmlf()
    data = make_dataset("blobs", n_samples=110, n_features=6, seed=1)
...
# %%
qmlfb_kernel_concentration_blobs_6q.run(kbench.llm)
