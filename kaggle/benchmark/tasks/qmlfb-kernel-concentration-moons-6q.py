...
Naive (bandwidth 1.0): acc 0.43, off-diagonal 0.0197. Tuned: 0.96 / 0.30. Data: make_dataset("moons", n_samples=110, n_features=6, seed=3)
"""
...
# %%
REF = {'naive_acc': 0.42857142857142855, 'naive_offdiag': 0.019737692806473, 'ceiling_acc': 0.9642857142857143, 'ceiling_offdiag': 0.29541478915367364, 'offdiag_bar': 0.1, 'acc_bar': 0.88, 'keep': True}
PARAMS = {'kind': 'moons', 'n_features': 6}
...
@kbench.task(name="qmlfb-kernel-concentration-moons-6q", description='Configure a quantum kernel classifier that escapes concentration on this dataset.')
def qmlfb_kernel_concentration_moons_6q(llm) -> float:
    _ensure_qmlf()
    data = make_dataset("moons", n_samples=110, n_features=6, seed=3)
...
# %%
qmlfb_kernel_concentration_moons_6q.run(kbench.llm)
