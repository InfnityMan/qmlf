...
@kbench.task(name="qmlfb-mitigate-s2n8", description='Chain readout correction and ZNE correctly to recover an ideal distribution.')
def qmlfb_mitigate_s2n8(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_mitigate_s2n8.run(kbench.llm)
