...
Synthetic but faithful: an ideal 4-outcome distribution passes through
depolarizing noise at scales 1/2/3, then a readout confusion matrix. Best
single raw measurement: L1 0.117. Readout correction alone:
0.060. Readout correction on every scale THEN
ZNE across scales: 0.023. Traps: 1-D input to zne,
...
# %%
qmlf_mitigation_pipeline.run(kbench.llm)
