...
n=200, m=20: {'pairwise_fidelity_circuits': 19900, 'statevector_simulations': 200, 'nystrom_fidelity_circuits': 4190}
"""
...
# %%
REF = {'expected': {'pairwise_fidelity_circuits': 19900, 'statevector_simulations': 200, 'nystrom_fidelity_circuits': 4190}, 'keep': True}
PARAMS = {'n_samples': 200, 'n_landmarks': 20}
...
@kbench.task(name="qmlfb-nisq-planning-200samples-20landmarks", description='Report the exact circuit counts of each kernel evaluation path for a planned hardware run.')
def qmlfb_nisq_planning_200samples_20landmarks(llm) -> float:
    _ensure_qmlf()
    data = None
...
# %%
qmlfb_nisq_planning_200samples_20landmarks.run(kbench.llm)
