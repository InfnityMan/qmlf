...
@kbench.task(name="qmlfb-nisqplan-n1000m50", description='Report the exact circuit counts of each kernel evaluation path for a planned hardware run.')
def qmlfb_nisqplan_n1000m50(llm) -> dict:
    _ensure_qmlf()
    data = None
...
# %%
qmlfb_nisqplan_n1000m50.run(kbench.llm)
