...
@kbench.task(name="qmlfb-nisqplan-n200m20", description='Report the exact circuit counts of each kernel evaluation path for a planned hardware run.')
def qmlfb_nisqplan_n200m20(llm) -> dict:
    _ensure_qmlf()
    data = None
...
# %%
qmlfb_nisqplan_n200m20.run(kbench.llm)
