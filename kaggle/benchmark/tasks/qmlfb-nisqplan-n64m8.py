...
@kbench.task(name="qmlfb-nisqplan-n64m8", description='Report the exact circuit counts of each kernel evaluation path for a planned hardware run.')
def qmlfb_nisqplan_n64m8(llm) -> dict:
    _ensure_qmlf()
    data = None
...
# %%
qmlfb_nisqplan_n64m8.run(kbench.llm)
