...
@kbench.task(name="qmlfb-proj-blobs10", description='Escape exponential concentration at this qubit count without reducing dimensionality.')
def qmlfb_proj_blobs10(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_proj_blobs10.run(kbench.llm)
