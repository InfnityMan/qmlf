...
@kbench.task(name="qmlfb-proj-blobs12", description='Escape exponential concentration at this qubit count without reducing dimensionality.')
def qmlfb_proj_blobs12(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_proj_blobs12.run(kbench.llm)
