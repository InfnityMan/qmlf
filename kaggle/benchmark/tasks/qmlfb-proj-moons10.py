...
@kbench.task(name="qmlfb-proj-moons10", description='Escape exponential concentration at this qubit count without reducing dimensionality.')
def qmlfb_proj_moons10(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_proj_moons10.run(kbench.llm)
