...
@kbench.task(name="qmlfb-proj-shift10", description='Escape exponential concentration at this qubit count without reducing dimensionality.')
def qmlfb_proj_shift10(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_proj_shift10.run(kbench.llm)
