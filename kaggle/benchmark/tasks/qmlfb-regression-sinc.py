...
@kbench.task(name="qmlfb-regression-sinc", description='Regress a physical response with a quantum kernel ridge that generalises.')
def qmlfb_regression_sinc(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_regression_sinc.run(kbench.llm)
