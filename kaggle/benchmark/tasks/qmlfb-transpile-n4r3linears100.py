...
@kbench.task(name="qmlfb-transpile-n4r3linears100", description='Report real transpiled resources, not the analytic projection, and label each correctly.')
def qmlfb_transpile_n4r3linears100(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_transpile_n4r3linears100.run(kbench.llm)
