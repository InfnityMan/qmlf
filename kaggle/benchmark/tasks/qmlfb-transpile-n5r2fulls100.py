...
@kbench.task(name="qmlfb-transpile-n5r2fulls100", description='Report real transpiled resources, not the analytic projection, and label each correctly.')
def qmlfb_transpile_n5r2fulls100(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_transpile_n5r2fulls100.run(kbench.llm)
