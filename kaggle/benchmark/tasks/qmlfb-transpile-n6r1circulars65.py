...
@kbench.task(name="qmlfb-transpile-n6r1circulars65", description='Report real transpiled resources, not the analytic projection, and label each correctly.')
def qmlfb_transpile_n6r1circulars65(llm) -> dict:
    _ensure_qmlf()
...
# %%
qmlfb_transpile_n6r1circulars65.run(kbench.llm)
