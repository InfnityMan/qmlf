...
@kbench.task(name="qmlfb-viz-hilbert", description='Produce a qmlf research figure in a headless sandbox and write it to disk.')
def qmlfb_viz_hilbert(llm) -> dict:
...
# %%
qmlfb_viz_hilbert.run(kbench.llm)
