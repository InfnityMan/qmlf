...
@kbench.task(name="qmlfb-vqe-2atoms", description='Deliver exact and deterministic VQE energies that respect the variational bound.')
def qmlfb_vqe_2atoms(llm) -> float:
    _ensure_qmlf()
...
# %%
qmlfb_vqe_2atoms.run(kbench.llm)
