...
@kbench.task(name="qmlfb-vqe-s1n3", description='Deliver exact and deterministic VQE energies that respect the variational bound.')
def qmlfb_vqe_s1n3(llm) -> dict:
    _ensure_qmlf()
